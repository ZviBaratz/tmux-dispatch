...
| [URL Extraction](urls) | `&` | Extract, copy, and open URLs from terminal scrollback | You want to open a link or copy a URL from your terminal output |
...
- Type `&` to switch to URL extraction — find and open URLs from your terminal output
